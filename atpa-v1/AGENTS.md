...
Installa **Automazione Totale Procedure Aziendali 1.1.0** su Windows 10/11 x64.
...
4. Leggi `INSTALL_RESULT.json`. Non dichiarare successo se `ok`, `mcp_configured`, `plugin_installed`, `recorder_installed` e `dashboard_ready` non sono tutti `true`.
