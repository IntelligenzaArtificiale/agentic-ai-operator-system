...
Esegui `%LOCALAPPDATA%\Programs\Intelligenza Artificiale Italia\Agentic AI Operator System\Update-Dashboard.ps1 -Open` con PowerShell. Lo script controlla MCP, plugin, registratore e catalogo, rigenera i dati e apre il dashboard locale.
